...
# FAISS 配置
EXCEL_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "Ballista_仕様書リスト.xlsx")
INDEX_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "faiss_index")
...
def get_vectorstore():
    ...
    if os.path.exists(os.path.join(INDEX_DIR, "index.faiss")):
        _vectorstore = FAISS.load_local(INDEX_DIR, embedding, allow_dangerous_deserialization=True)
    else:
